...
export class InitialMigration1683316523314 implements MigrationInterface {
    name = 'InitialMigration1683316523314'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "real-estate" ("id" SERIAL NOT NULL, "sold" boolean NOT NULL DEFAULT false, "value" numeric(12,2) NOT NULL DEFAULT '0', "size" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL, "addressId" integer, "categoryId" integer, CONSTRAINT "REL_63802c3c646f1a0b67312dc361" UNIQUE ("addressId"), CONSTRAINT "PK_bd0224590c0088913923e98e09e" PRIMARY KEY ("id"))`);
